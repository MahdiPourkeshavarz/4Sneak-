...
export function firstLandingPage() {
  ...
  img1.src = '../src/assets/landings/slide1.png';
  img1.alt = '_';
  ...
  link.innerHTML = '<a href="/landing/2" data-navigo><button class="bg-slate-900 rounded-3xl px-28 py-2 mt-4 text-white">Next</button></a>';
